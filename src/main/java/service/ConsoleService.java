     ...
     public void showMainMenu() {
        ...
        while (exit) {
            ...
            switch (point) {
                ...
                case 3 -> userProductDAO.deleteUserById();
                case 4 -> userProductDAO.deleteProductById();
                case 5 -> purchaseResultDAO.makePurchase(userProductDAO.getUsers(), userProductDAO.getProducts());
                case 6 -> userProductDAO.printUsers();
                case 7 -> userProductDAO.printProducts();
